...
if (typeof Trail !== "undefined") window.Trail = Trail;
if (typeof Burst !== "undefined") window.Burst = Burst;
if (typeof HopRing !== "undefined") window.HopRing = HopRing;
if (typeof PacketAnimator !== "undefined") window.PacketAnimator = PacketAnimator;
if (typeof getMeta !== "undefined") window.getMeta = getMeta;
if (typeof PA !== "undefined") window.PA = PA;
if (typeof TYPE_META !== "undefined") window.TYPE_META = TYPE_META;
