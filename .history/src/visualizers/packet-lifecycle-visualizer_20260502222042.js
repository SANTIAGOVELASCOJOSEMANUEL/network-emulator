...
class PacketLifecycleVisualizer {
    ...
    show(packetTrace) {
        if (!packetTrace || !packetTrace.hops || packetTrace.hops.length === 0) {
            console.warn('No hay información de saltos en el paquete');
            return;
        }
...
if (typeof PacketLifecycleVisualizer !== "undefined") window.PacketLifecycleVisualizer = PacketLifecycleVisualizer;
